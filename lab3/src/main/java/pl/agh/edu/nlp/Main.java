...
public class Main {
	...
	public static void main(String[] args) {
		...
		statisticsCollector.createFileWithRanking(new File(outputPath + "ranking.txt"));
		statisticsCollector.getCumlativePercentageDataForZipfLaw(new File(outputPath + "zipfLawPercentage.txt"));
